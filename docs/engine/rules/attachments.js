...
export function runAttachmentChecks(workbook) {
  ...
  // Geometry/attachment issues deduct a point. Stealth issues remain warning-only on main.
  ...
  if (stealthIssues > 0 && !feedback.includes(STRINGS.attachment.stealthWarning)) {
    feedback.push(STRINGS.attachment.stealthWarning);
  }
