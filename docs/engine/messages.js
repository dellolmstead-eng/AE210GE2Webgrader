export const STRINGS = {
  ...
  constraint: {
    ...
    takeoffObj: "Takeoff distance meets objective (≤2500 ft): %.0f ft",
    landingHigh: "Landing distance exceeds threshold (5000 ft): %.0f ft",
    landingObj: "Landing distance meets objective (≤3500 ft): %.0f ft",
  ...
  attachment: {
    ...
    engineAftStructure: "Engine aft end is %.2f ft ahead of the aft end of the fuselage/wing; limit is %.2f ft (two engine diameters).",
    ...
    pcsTrailParallel:
      "Pitch control surface trailing edge sweep %.1f° must be parallel to the wing leading edge %.1f° or its normal must reach the fuselage centerline when the surface remains within the fuselage average height (+/- %.1f°).",
    ...
    vtTrail: "Vertical tail trailing edge sweep %.1f° must be parallel to the wing leading edge %.1f° or its normal must reach the fuselage centerline when the tail remains within the fuselage average height (+/- %.1f°).",
